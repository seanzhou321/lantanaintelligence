...
- **Physical injury or death** arising from the use, misuse, or malfunction of any tool borrowed or lent through the platform.
- **Property damage** caused by any tool during or after a rental transaction.
- **Financial loss** arising from rental disputes, unpaid debts between Members, or errors in payment acknowledgment records.
- **Tool loss or theft** occurring during a rental period, beyond the Member-to-Member obligations described in the **Community Bylaws**.
- **Service outages or data errors** affecting rental records or bill splitting calculations, as further described in Section 10.2 of the Terms of Service.
